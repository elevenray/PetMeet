...
<?php
    session_start();
    //check to see if registered user is togged in to the session
    if(isset($_SESSION['is_login'])){
        //Keep registered user logged in as they complete any actions.
        ...
        if(isset($_POST['send'])) {
          ...
          //Regardless of user actions, continue the following
...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Setting up PetMeet</title>
  </head>
  <body>
    <!-- Navbar -->
    <?php
